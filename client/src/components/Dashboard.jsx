    ...
    <>
      <div className="pt-6 px-4">
        <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          <div className="bg-[#232627] shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
        ...
        <div className="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
          <div className="bg-[#232627] shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
          ...
          <div className="bg-[#232627] shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <h3 className="text-xl leading-none font-bold text-gray-100 mb-10">
              Watching Analysis
            </h3>
            <div className="block w-full overflow-x-auto">
              <table className="items-center w-full bg-transparent border-collapse">
                <thead>
                  <tr>
                    <th className="px-4 bg-[#232627] text-gray-100 align-middle py-3 text-xs font-semibold text-left uppercase  whitespace-nowrap">
                      Top Channels
                    </th>
                    <th className="px-4 bg-[#232627] text-gray-100 align-middle py-3 text-xs font-semibold text-left uppercase  whitespace-nowrap">
                      Users
                    </th>
                    <th className="px-4 bg-[#232627] text-gray-100 align-middle py-3 text-xs font-semibold text-left uppercase  whitespace-nowrap min-w-140-px" />
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  <tr className="text-gray-500">
                    ...
                    <td className="border-t-0 px-4 align-middle text-xs font-medium text-gray-200 font-figtree whitespace-nowrap p-4">
                      5,649
                    </td>
                  ...
                  <tr className="text-gray-500">
                    ...
                    <td className="border-t-0 align-middle text-xs font-medium text-gray-200 font-figtree whitespace-nowrap p-4 pb-0">
                      456
                    </td>
